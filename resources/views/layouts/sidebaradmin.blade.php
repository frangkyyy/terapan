    ...
    <div class="sidebar">
        ...
        <nav class="mt-2">
            <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                ...
                <li class="nav-item">
                    <a href="{{ url('datauser/admin') }}" class="nav-link">
                ...
                <li class="nav-item">
                    <a href="{{ url('datauser/guru') }}" class="nav-link">
                ...
                <li class="nav-item">
                    <a href="{{ url('datauser/wakasek') }}" class="nav-link">
                        <i class="nav-icon fas fa-calendar-alt"></i>
                        <p>
                            Data Wakasek
                        </p>
                ...
                <li class="nav-item">
                    <a href="{{ url('datauser/siswa') }}" class="nav-link">
                        <i class="nav-icon fas fa-calendar-alt"></i>
                        <p>
                            Data Siswa
                        </p>
